...
cd /d D:\Poject C\mliot-embeddedc-2026-hw\week04\Task3
...
STM32_Programmer_CLI -c port=SWD sn=E1007200D0D2139393740544 -w build/Task3_led_blink.bin 0x08000000 -v -rst
